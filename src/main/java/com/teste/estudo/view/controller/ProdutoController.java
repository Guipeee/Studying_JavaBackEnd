package com.teste.estudo.view.controller;
...
import com.teste.estudo.view.model.ProdutoResponse;
import com.teste.estudo.view.model.ProdutoRequest;
...
public class ProdutoController {
    ...
    public ResponseEntity<ProdutoResponse> adicionar( @RequestBody ProdutoRequest produtoReq){
        ModelMapper mapper = new ModelMapper();
        ProdutoDTO produtoDto = mapper
        .map(produtoReq, ProdutoDTO.class);
        produtoDto = produtoService.adicionar(produtoDto);
        
        return new ResponseEntity<>(mapper
        .map(produtoDto, ProdutoResponse.class), HttpStatus.CREATED);
    }
    ...
    @DeleteMapping
    public ResponseEntity<?> deletarAll(){
        produtoService.deletarAll();
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }

    @PutMapping("/{id}")
    public ResponseEntity<ProdutoResponse> atualizar(@RequestBody ProdutoRequest produtoReq, 
